...
let cubeMesh, sphereMesh, polyhedronMesh;
...
function createCorps() {
  ...
  gui.add(params, "repeatX", -4, 4).onChange(params.updateRepeat);
  gui.add(params, "repeatY", -4, 4).onChange(params.updateRepeat);
  gui.add(params, "repeatWrapping").onChange(params.updateRepeat);
}
...
function setupControls() {
  params = {
    ...
    updateRepeat: function (e) {
      cubeMesh.material.map.repeat.set(params.repeatX, params.repeatY);
      sphereMesh.material.map.repeat.set(params.repeatX, params.repeatY);
      polyhedronMesh.material.map.repeat.set(params.repeatX, params.repeatY);

      if (params.repeatWrapping) {
