...
function setupControls() {
  ...
  gui.add(params, "segments", 0, 40).onChange(params.redraw);
  gui.add(params, "thetaStart", 0, 2 * Math.PI).onChange(params.redraw);
  gui.add(params, "thetaLength", 0, 2 * Math.PI).onChange(params.redraw);
